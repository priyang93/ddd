...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        home_button.setStyleSheet("height:40px; line=heigth:40px; background-color:white ; color:black")
        message_button=QPushButton()
        message_icon=QIcon(GraphicsDirectoryPath("Chats.png"))
        message_button.setIcon(message_icon)
        message_button.setText(" Chat")
        message_button.setStyleSheet("height:40px; line=heigth:40px; background-color:white ; color:black")
